...
import { FoydaSearch } from 'src/sections/foyda/foyda-search';
import { FoydaTable } from 'src/sections/foyda/foyda-table';
...
const PageFoyda = withAllRouterGuard(() => {
    ...
    useEffect(() => {
        axios.post(base_URL + "/paymentRoutes/profits", {
...

                        {
                            filteredAppointments.length > 0 ? (
                                <FoydaTable
                                    ...
                                    items={{appointmentsApi, chiqim, startDate, endDate}}
...
PageFoyda.getLayout = (page) => (
    <DashboardLayout>
        {page}
    </DashboardLayout>
);

export default PageFoyda;
