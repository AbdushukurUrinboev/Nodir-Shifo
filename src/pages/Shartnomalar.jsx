...
import { ShartnomalarSearch } from 'src/sections/shartnomalar/shartnomalar-search';
import { ShartnomalarTable } from 'src/sections/shartnomalar/shartnomalar-table';
...
const PageShartnomalar = withAllRouterGuard(() => {
  ...
  const [endDate, setEndDate] = useState(new Date(`${year}/${month}/${day}`));



  useEffect(() => {    
    axios.post(base_URL + "/appointments-archive", {
...
PageShartnomalar.getLayout = (page) => (
  <DashboardLayout>
    {page}
  </DashboardLayout>
);

export default PageShartnomalar;
