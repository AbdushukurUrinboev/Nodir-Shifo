...
import { ProfitSearch } from 'src/sections/profit/profit-search';
import { ProfitTable } from 'src/sections/profit/profit-table';
...
const PageProfit = withAllRouterGuard(() => {
...
PageProfit.getLayout = (page) => (
    <DashboardLayout>
        {page}
    </DashboardLayout>
);

export default PageProfit;
